# -*- coding: utf-8 -*-
#
# yawf documentation build configuration file, created by
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'yawf_sample.settings'
...
latex_documents = [
  ('index', 'yawf.tex', u'yawf Documentation',
   u'Author', 'manual'),
]
