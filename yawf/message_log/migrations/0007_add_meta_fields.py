...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageLog.message_params_dehydrated'
        db.add_column('message_log_messagelog', 'message_params_dehydrated', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'MessageLog.transition_result'
        db.add_column('message_log_messagelog', 'transition_result', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'MessageLog.message_params_dehydrated'
        db.delete_column('message_log_messagelog', 'message_params_dehydrated')

        # Deleting field 'MessageLog.transition_result'
        db.delete_column('message_log_messagelog', 'transition_result')
    ...
    models = {
        ...
        'message_log.messagelog': {
            ...
            'revision': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'message_log'", 'null': 'True', 'to': "orm['reversion.Revision']"}),
